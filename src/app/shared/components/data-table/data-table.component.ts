...
@Component({
  ...
  styles: [
    ...
    .table-row{display:grid;grid-template-columns:32px 140px 100px 100px 100px 100px 100px 100px 100px;gap:10px;align-items:center;padding:12px 14px}
    .table-head{font-weight:700;color:#9ca3af;font-size:0.75rem;text-transform:uppercase;letter-spacing:0.4px;background:transparent;padding:10px 14px;margin-bottom:6px}
    ...
    .name-text{font-weight:700;color:#0f172a;font-size:0.85rem}
    ...
    .align-right{text-align:right;font-size:0.8rem}
