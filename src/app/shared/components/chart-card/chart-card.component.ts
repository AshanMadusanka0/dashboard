...
@Component({
  ...
  styles: [
    `:host{display:block}
    .chart-card{background: linear-gradient(180deg, rgba(255,255,255,0.75), rgba(255,255,255,0.55)); border-radius:12px; padding:14px; box-shadow:0 4px 12px rgba(2,6,23,0.08); border:1px solid rgba(16,24,40,0.05); height:90%}
    ...
    .chart-card__body{min-height:280px; display:flex; align-items:center; justify-content:center}
